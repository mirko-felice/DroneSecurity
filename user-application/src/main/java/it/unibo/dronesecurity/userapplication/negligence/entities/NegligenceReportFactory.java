...
public final class NegligenceReportFactory {
     ...
     * @param negligent the {@link it.unibo.dronesecurity.userapplication.auth.entities.Courier} that committed the
     *                  negligence
     * @param assignee the {@link it.unibo.dronesecurity.userapplication.auth.entities.Maintainer} assigned to the
     *                 report
