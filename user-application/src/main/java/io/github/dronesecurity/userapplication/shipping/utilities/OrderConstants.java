...
public final class OrderConstants {
    ...
    /**
     * {@link io.github.dronesecurity.userapplication.shipping.entities.PlacedOrder} state.
     */
    public static final String PLACED_ORDER_STATE = "Order is placed.";

    /**
     * {@link io.github.dronesecurity.userapplication.shipping.entities.FailedOrder} state.
     */
    public static final String FAILED_ORDER_STATE = "Order delivery failed.";

    /**
     * {@link io.github.dronesecurity.userapplication.shipping.entities.DeliveredOrder} state.
     */
    public static final String DELIVERED_ORDER_STATE = "Order delivery succeeded.";

    /**
     * {@link io.github.dronesecurity.userapplication.shipping.entities.DeliveringOrder} state.
     */
    public static final String DELIVERING_ORDER_STATE = "Order is delivering.";

    /**
     * {@link io.github.dronesecurity.userapplication.shipping.entities.RescheduledOrder} state.
     */
