...
import io.github.dronesecurity.userapplication.domain.reporting.negligence.entities.NegligenceReportWithID;
...
public class NegligenceReportWithIDSerializer extends JsonSerializer<NegligenceReportWithID> {
    ...
    public void serialize(final @NotNull NegligenceReportWithID value, final @NotNull JsonGenerator gen,
        ...
        gen.writeNumberField(NegligenceConstants.ORDER_ID, value.getOrderId());
        ...
        if (value instanceof ClosedNegligenceReport) {
            ...
            gen.writeStringField(NegligenceConstants.SOLUTION,
                    ((ClosedNegligenceReport) value).getSolution().getSolution());
        }
        gen.writeEndObject();
        gen.flush();
    }
